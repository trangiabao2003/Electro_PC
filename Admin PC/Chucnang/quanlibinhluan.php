            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./quanlithongtindonhang.php" class="nav-item nav-link"><i
                        ...
                        đơn hàng</a>
                    <a href="./quanlibinhluan.php" class="nav-item nav-link active"><i
                            class="fa fa-chart-bar me-2 "></i>Quản lý
                        bình
                        luận</a>
                </div>
            </nav>
            ...
            <table class="table table-bordered text-center mt-3" id="chitiettourTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $rep_comment ?></td>
                        <td><?php echo $status ?></td>
                        <td>
                            <a href="./Quanlibinhluan/update.php?id=<?php echo $id; ?>" type="button"
                                class="btn btn-warning">Sửa</a>
                            <a href="./Quanlibinhluan/delete.php?id=<?php echo $id; ?>"
            ...
            <div>
                <ul class="pagination">
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        echo ' <li class="page-item"><a class="page-link" href="quanlibinhluan.php?page=' . $i . '">' . $i . '</a></li>';
                    }
                    ?>
                </ul>
            </div>

    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-end">
                <a href="./Quanlidanhmuc_info/add.php" class="btn btn-success px-4 py-2 rounded-3 me-3">Thêm</a>
            </div>
            <table class="table table-bordered text-center mt-3" id="chitiettourTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img width="100px" height="100px" class="hinhanh"
                                src="../assets/image/<?php echo $image; ?>"></td>
                        <td>
                            <a href="./Quanlidanhmuc_info/update.php?id=<?php echo $id; ?>" type="button"
                                class="btn btn-warning">Sửa</a>
                            <a href="./Quanlidanhmuc_info/delete.php?id=<?php echo $id; ?>"
            ...
            <div>
                <ul class="pagination">
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        echo ' <li class="page-item"><a class="page-link" href="quanlidanhmuc.php?page=' . $i . '">' . $i . '</a></li>';
                    }
                    ?>
                </ul>
            </div>

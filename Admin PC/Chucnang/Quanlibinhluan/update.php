...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../quanlibinhluan.php" class="nav-item nav-link active"><i
                            class="fa fa-chart-bar me-2"></i>Quản
                        lý
                        bình
                        luận</a>
                </div>
            ...
            <div class="mt-5 mx-5">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">Trả lời bình luận người dùng</label>
                            <textarea name="rep_comment" id="rep_comment" placeholder="Trả lời bình luận"
                                class="form-control"><?php echo $rep_comment; ?></textarea>
                        </div>
                        <br>
    ...
    <script>
    ClassicEditor
        .create(document.querySelector('#rep_comment'))
        .catch(error => {
            console.error(error);
        });
    </script>

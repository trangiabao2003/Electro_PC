    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="./quanlisanpham.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Quản lý
                        sản
                        phẩm</a>
                    <a href="./quanlisanphamnoibat.php" class="nav-item nav-link active"><i
                            class="fa fa-table me-2 "></i>Quản
                        lý sản phẩm nổi
                        bật</a>
        ...
        <div class="content">
            ...
            <div class="mt-3 text-center">
                <h3>Quản lí sản phẩm nổi bật</h3>
            </div>
            <table class="table table-bordered text-center mt-3" id="chitiettourTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img height="100px" width="100px" class="hinhanh"
                                src="../assets/image/<?php echo $image_name; ?>"></td>
                        <td>
                            <a href="./Quanlisanphamnoibat/update.php?id=<?php echo $id; ?>" type="button"
            ...
            <div>
                <ul class="pagination">
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        echo ' <li class="page-item"><a class="page-link" href="quanlisanphamnoibat.php?page=' . $i . '">' . $i . '</a></li>';
                    }
                    ?>
                </ul>
            </div>

    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-end">
                <a href="./Quanliuser_info/add.php" class="btn btn-success px-4 py-2 rounded-3 me-3">Thêm</a>
            </div>
            <table class="table table-bordered text-center mt-3" id="chitiettourTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $SDT; ?></td>
                        <td>
                            <a href="./Quanliuser_info/update.php?id=<?php echo $id; ?>" type="button"
                                class="btn btn-warning">Sửa</a>
                            <a href="./Quanliuser_info/delete.php?id=<?php echo $id; ?>"
            ...
            <div>
                <ul class="pagination">
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        echo ' <li class="page-item"><a class="page-link" href="quanlithongtinnguoidung.php?page=' . $i . '">' . $i . '</a></li>';
                    }
                    ?>
                </ul>
            </div>
